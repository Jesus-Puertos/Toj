...
export function BottomNavBar() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 border-t border-outline-variant bg-surface/95 backdrop-blur-md"
              ...
              >
                <span
                  className={`material-symbols-outlined transition-all ${
                    isActive ? 'text-primary text-[26px]' : 'text-on-surface-variant text-[24px]'
                  }`}
